...
/* 'new Date()' creates an instance of the Date class rom which we can get all kinds of things such as current date, hours, minutes, seconds etc */
function setDate() {
    const now = new Date();
...
- I multiplied by 360 because the circumference of a circle is 360 degrees */
    ...
    /* 
    - Here, how the minutes will rotate is stored in 'minutesDegrees' variable in order to turn the hand. 
